...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'KRISHNA/Babu', 'krishna5.jpg');
...
async function makeImage({ one, two }) {
    ...
    let pairing_img = await jimp.read(__root + "/krishna5.jpg");
    ...
    pairing_img.composite(circleOne.resize(350, 350), 90, 170).composite(circleTwo.resize(350, 350), 825, 168);
